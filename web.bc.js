...
fb(a,b){return aX(h(a).add(h(b)))}function
fc(b,a){a=h(a);if(a.equals(h(0)))bE();return aX(h(b).divide(h(a)))}function
...
ku(a){cw[bn]={serialize:kj,deserialize:kk,hash:kt,compare:kq};return 0}function
kv(a,b){return aX(h(a).multiply(h(b)))}function
kw(b,c){var
a=b*c;return a!=(a|0)}function
kx(a){return aX(h(a).negate())}function
fd(a,b){return aX(h(a).subtract(h(b)))}function
j0(a){switch(a[2]){case-8:case-11:case-12:return 1;default:return 0}}function
jH(b){var
a=d;if(b[0]==0){a+=b[1][1];if(b.length==3&&b[2][0]==0&&j0(b[1]))var
f=b[2],g=1;else
var
g=2,f=b;a+="(";for(var
...
c=aE(dT);if(c)c(a,false);else{var
d=jH(a),b=aE(dM);if(b)b(0);g.console.error(cj+d+dY)}}else
throw a}function
kc(){var
a=g;if(a.process&&a.process.on)a.process.on("uncaughtException",function(b,c){eY(b);a.process.exit(2)});else
if(a.addEventListener)a.addEventListener("error",function(a){if(a.error)eY(a.error)})}kc();function
...
ju(a,b,c,d,e,f,g,h){return a.length==7?a(b,c,d,e,f,g,h):aA(a,[b,c,d,e,f,g,h])}jI();var
bJ=[x,a(eE),-1],cT=[x,a(dV),-2],cQ=[x,a(dZ),-3],cP=[x,a(ei),-4],bd=[x,a(em),-7],cR=[x,a(d7),-8],cS=[x,a(ep),-9],r=[x,a(eA),-11],cU=[x,a(dL),-12],c_=[0,dS],jt=[4,0,0,0,[12,45,[4,0,0,0,0]]],bV=[0,[11,a('File "'),[2,0,[11,a('", line '),[4,0,0,0,[11,a(d$),[4,0,0,0,[12,45,[4,0,0,0,[11,a(": "),[2,0,0]]]]]]]]]],a('File "%s", line %d, characters %d-%d: %s')];X(11,cU,dL);X(10,r,eA);X(9,[x,a(ef),-10],ef);X(8,cS,ep);X(7,cR,d7);X(6,bd,em);X(5,[x,a(et),-6],et);X(4,[x,a(d0),-5],d0);X(3,cP,ei);X(2,cQ,dZ);X(1,cT,dV);X(0,bJ,eE);var
fn=a("output_substring"),fk=a("%.12g"),fj=a(af),fh=a("true"),fi=a("false"),fo=a("\\\\"),fp=a("\\'"),fq=a("\\b"),fr=a("\\t"),fs=a("\\n"),ft=a("\\r"),fy=a("Bytes.of_seq: cannot grow bytes"),fx=a("String.blit / Bytes.blit_string"),fw=a("Bytes.blit"),fv=a("String.sub / Bytes.sub"),fB=a("String.contains_from / Bytes.contains_from"),fC=a("Stdlib.Queue.Empty"),fH=a("Buffer.add_substring/add_subbytes"),fG=a("Buffer.add: cannot grow buffer"),fF=[0,a(es),93,2],fE=[0,a(es),94,2],fQ=a("%c"),fR=a("%s"),fS=a(dJ),fT=a(d6),fU=a(eg),fV=a(dP),fW=a("%f"),fX=a("%B"),fY=a("%{"),fZ=a("%}"),f0=a("%("),f1=a("%)"),f2=a("%a"),f3=a("%t"),f4=a("%?"),f5=a("%r"),f6=a("%_r"),f7=[0,a(w),850,23],gg=[0,a(w),814,21],f_=[0,a(w),815,21],gh=[0,a(w),818,21],f$=[0,a(w),819,21],gi=[0,a(w),822,19],ga=[0,a(w),823,19],gj=[0,a(w),826,22],gb=[0,a(w),827,22],gk=[0,a(w),831,30],gc=[0,a(w),832,30],ge=[0,a(w),836,26],f8=[0,a(w),837,26],gf=[0,a(w),846,28],f9=[0,a(w),847,28],gd=[0,a(w),851,23],hm=a(ee),hk=[0,a(w),1558,4],hl=a("Printf: bad conversion %["),hn=[0,a(w),1626,39],ho=[0,a(w),1649,31],hp=[0,a(w),1650,31],hq=a("Printf: bad conversion %_"),hr=a(ed),hs=a(eh),ht=a(ed),hu=a(eh),hi=a(cg),hg=a("neg_infinity"),hh=a(eD),hf=a(af),g1=a("%+nd"),g2=a("% nd"),g4=a("%+ni"),g5=a("% ni"),g6=a("%nx"),g7=a("%#nx"),g8=a("%nX"),g9=a("%#nX"),g_=a("%no"),g$=a("%#no"),g0=a("%nd"),g3=a(eg),ha=a("%nu"),gO=a("%+ld"),gP=a("% ld"),gR=a("%+li"),gS=a("% li"),gT=a("%lx"),gU=a("%#lx"),gV=a("%lX"),gW=a("%#lX"),gX=a("%lo"),gY=a("%#lo"),gN=a("%ld"),gQ=a(d6),gZ=a("%lu"),gB=a("%+Ld"),gC=a("% Ld"),gE=a("%+Li"),gF=a("% Li"),gG=a("%Lx"),gH=a("%#Lx"),gI=a("%LX"),gJ=a("%#LX"),gK=a("%Lo"),gL=a("%#Lo"),gA=a("%Ld"),gD=a(dP),gM=a("%Lu"),go=a("%+d"),gp=a("% d"),gr=a("%+i"),gs=a("% i"),gt=a("%x"),gu=a("%#x"),gv=a("%X"),gw=a("%#X"),gx=a("%o"),gy=a("%#o"),gn=a(br),gq=a(dJ),gz=a(ee),fI=a("@]"),fJ=a("@}"),fK=a("@?"),fL=a("@\n"),fM=a("@."),fN=a("@@"),fO=a("@%"),fP=a("@"),gl=a("CamlinternalFormat.Type_mismatch"),hy=a(d),hz=[0,[11,a(dO),[2,0,[2,0,0]]],a(", %s%s")],hZ=[0,[11,a(cj),[2,0,[12,10,0]]],a(ey)],h0=[0,[11,a("Fatal error in uncaught exception handler: exception "),[2,0,[12,10,0]]],a("Fatal error in uncaught exception handler: exception %s\n")],hY=a("Fatal error: out of memory in uncaught exception handler"),hW=[0,[11,a(cj),[2,0,[12,10,0]]],a(ey)],hR=[0,[2,0,[12,10,0]],a("%s\n")],hS=[0,[11,a(d9),0],a(d9)],hJ=a("Raised at"),hK=a("Re-raised at"),hL=a("Raised by primitive operation at"),hM=a("Called from"),hN=a(" (inlined)"),hP=a(d),hO=[0,[2,0,[12,32,[2,0,[11,a(' in file "'),[2,0,[12,34,[2,0,[11,a(", line "),[4,0,0,0,[11,a(d$),jt]]]]]]]]]],a('%s %s in file "%s"%s, line %d, characters %d-%d')],hQ=[0,[2,0,[11,a(" unknown location"),0]],a("%s unknown location")],hE=a("Out of memory"),hF=a("Stack overflow"),hG=a("Pattern matching failed"),hH=a("Assertion failed"),hI=a("Undefined recursive module"),hA=[0,[12,40,[2,0,[2,0,[12,41,0]]]],a("(%s%s)")],hB=a(d),hC=a(d),hD=[0,[12,40,[2,0,[12,41,0]]],a("(%s)")],hx=[0,[4,0,0,0,0],a(br)],hv=[0,[3,0,0],a("%S")],hw=a(ek),hT=[0,a(d),a("(Cannot print locations:\n bytecode executable program file not found)"),a("(Cannot print locations:\n bytecode executable program file appears to be corrupt)"),a("(Cannot print locations:\n bytecode executable program file has wrong magic number)"),a("(Cannot print locations:\n bytecode executable program file cannot be opened;\n -- too many open files. Try running with OCAMLRUNPARAM=b=2)")],ij=[3,0,3],ik=a(af),id=a(bw),ie=a("<\/"),ig=a(d),h$=a(bw),ia=a(cq),ib=a(d),h9=a("\n"),h8=[0,a(d)],h4=a(d),h5=a(d),h6=a(d),h7=a(d),h3=[0,a(d),0,a(d)],h2=a(d),h1=a("Stdlib.Format.String_tag"),is=a("Js_of_ocaml__Js.Error"),it=a(cd),ix=a("Z.Overflow"),iz=a("ml_z_overflow"),iA=a(br),iR=a("Push"),iS=a("Pop"),iT=a("Add"),iU=a("Sub"),iV=a("Mul"),iW=a("Div"),iX=a("Equal"),iY=a("Lte"),iZ=a("And"),i0=a("Or"),i1=a("Not"),i2=a("Trace"),i3=a("Local"),i4=a("Global"),i5=a("Lookup"),i6=a(a5),i7=a("Begin"),i8=a(a5),i9=a("Else"),i_=a("If"),i$=a(a5),ja=a("Fun"),jb=a("Call"),jc=a(a5),jd=a("Try"),je=a("Case"),jf=a(a5),jg=a("Switch"),jm=[0,a(d5),0],jl=[0,a(d5),0],jh=a("; "),ji=a(d),jj=a("]"),jk=a("["),iQ=a(ct),iP=a(co),iO=a(J),iN=a(dK),iI=a(" \f\n\r\t"),iB=a(dK),iC=a(co),iD=a(ct),iE=a("<fun>"),iK=[0,a(co),[0,a(ct),0]],jn=a("input"),js=a(ec),jp=a("output"),jr=a(ec);function
q(a){if(typeof
...
fg(a){return a?fh:fi}function
aH(a,b){if(a){var
c=a[1];return[0,c,aH(a[2],b)]}return b}j5(0);var
fl=e3(1),aa=e3(2);function
fm(b){function
a(b){var
a=b;for(;;){if(a){var
c=a[2],d=a[1];try{aD(d)}catch(a){a=bH(a);if(a[1]!==cT)throw a;var
e=a}var
a=c;continue}return 0}}return a(j6(0))}function
aY(b,a){return cG(b,a,0,n(a))}function
cV(a){aY(aa,a);e4(aa,10);return aD(aa)}var
bK=[0,fm];function
cW(d){for(;;){var
...
bL(a){return b(bK[1],0)}cK(a(dM),bL);if(kh(0))cW(function(a){return jJ(a)});var
...
cY(d,c){var
a=c;for(;;){if(a){var
b=a[1],e=a[2],f=b[2];if(0===jD(b[1],d))return[0,f];var
a=e;continue}return 0}}function
cZ(b,a){return b<=a?b:a}function
al(a,c){var
b=y(a);jG(b,0,a,c);return b}function
c0(c,b,a){if(0<=b&&0<=a&&!((H(c)-a|0)<b)){var
d=y(a);aw(c,b,d,0,a);return d}return as(fv)}function
c1(c,b,a){return L(c0(c,b,a))}function
bM(e,c,d,b,a){if(0<=a&&0<=c&&!((H(e)-a|0)<c)&&0<=b&&!((H(d)-a|0)<b))return aw(e,c,d,b,a);return as(fw)}function
am(e,c,d,b,a){if(0<=a&&0<=c&&!((n(e)-a|0)<c)&&0<=b&&!((H(d)-a|0)<b))return ax(e,c,d,b,a);return as(fx)}function
c2(b,a){return L(al(b,a))}function
fz(e,d,c,b){var
a=c;for(;;){if(d<=a)throw bd;if($(e,a)===b)return a;var
a=a+1|0;continue}}function
fA(b,a,d){var
c=n(b);if(0<=a&&!(c<a))try{fz(b,c,a,d);var
e=1;return e}catch(a){a=bH(a);if(a===bd)return 0;throw a}return as(fB)}ar(0);function
aZ(a){return[0,0,0]}function
a0(a){a[1]=0;a[2]=0;return 0}function
...
bc(fG);var
e=y(b[1]);bM(a[1],0,e,0,a[2]);a[1]=e;a[3]=b[1];if((a[2]+c|0)<=a[3]){if((d+c|0)<=a[3])return 0;throw[0,r,fE]}throw[0,r,fF]}}function
a1(a,c){var
...
switch(a[0]){case
0:return a[1];case
1:return a[1];default:return V(fP,c2(1,a[1]))}}function
bQ(b,c){var
a=c;for(;;)if(typeof
a==="number")return 0;else
switch(a[0]){case
...
a=k;continue;case
8:var
l=a[2],m=a[1];E(b,fY);bQ(b,m);E(b,fZ);var
a=l;continue;case
9:var
n=a[3],o=a[1];E(b,f0);bQ(b,o);E(b,f1);var
a=n;continue;case
10:var
p=a[1];E(b,f2);var
a=p;continue;case
...
14:a=4;break;case
8:a=5;break;case
9:a=6;break;default:throw[0,r,f7]}else
switch(d[0]){case
0:var
e=0,w=d[1];if(typeof
...
12:a=2;break;case
13:a=3;break;case
14:a=4;break;default:m=1}if(m)throw[0,r,ge];break;case
9:var
...
12:a=2;break;case
13:a=3;break;case
14:a=4;break;default:n=1}if(n)throw[0,r,gf];break;case
10:var
Q=d[1];if(typeof
c!=="number"&&10===c[0])return[10,v(Q,c[1])];throw[0,r,gg];case
11:var
o=0,R=d[1];if(typeof
c==="number")o=1;else
switch(c[0]){case
10:break;case
11:return[11,v(R,c[1])];default:o=1}if(o)throw[0,r,gh];break;case
12:var
p=0,S=d[1];if(typeof
c==="number")p=1;else
switch(c[0]){case
10:break;case
11:a=1;break;case
12:return[12,v(S,c[1])];default:p=1}if(p)throw[0,r,gi];break;case
13:var
q=0,T=d[1];if(typeof
c==="number")q=1;else
switch(c[0]){case
...
11:a=1;break;case
12:a=2;break;case
13:return[13,v(T,c[1])];default:q=1}if(q)throw[0,r,gj];break;default:var
s=0,U=d[1];if(typeof
c==="number")s=1;else
switch(c[0]){case
10:break;case
...
12:a=2;break;case
13:a=3;break;case
14:return[14,v(U,c[1])];default:s=1}if(s)throw[0,r,gk]}switch(a){case
0:throw[0,r,f_];case
1:throw[0,r,f$];case
2:throw[0,r,ga];case
3:throw[0,r,gb];case
4:throw[0,r,gc];case
5:throw[0,r,f8];case
6:throw[0,r,f9];default:throw[0,r,gd]}}var
A=[x,gl,ar(0)];function
bf(b,a){if(typeof
...
5:var
an=b[4],ao=b[1],i=a2(b[2],b[3],a),j=i[3],ap=i[1];if(typeof
j!=="number"&&3===j[0]){var
aq=i[2],C=m(an,j[1]);return[0,[5,ao,ap,aq,C[1]],C[2]]}throw A;case
6:var
ar=b[4],as=b[1],k=a2(b[2],b[3],a),l=k[3],at=k[1];if(typeof
l!=="number"&&4===l[0]){var
au=k[2],D=m(ar,l[1]);return[0,[6,as,at,au,D[1]],D[2]]}throw A;case
7:var
av=b[4],aw=b[1],n=a2(b[2],b[3],a),o=n[3],ax=n[1];if(typeof
o!=="number"&&5===o[0]){var
ay=n[2],E=m(av,o[1]);return[0,[7,aw,ax,ay,E[1]],E[2]]}throw A;case
8:var
az=b[4],aA=b[1],p=a2(b[2],b[3],a),r=p[3],aB=p[1];if(typeof
r!=="number"&&6===r[0]){var
...
j=0;if(dR!==P(a,1)&&88!==P(a,1)){f=1;j=1}if(!j){az(c,1,P(a,1));am(a,2,c,(d-b|0)+2|0,b-2|0)}}else
f=1;if(f)am(a,0,c,d-b|0,b)}}return L(c)}function
aN(k,b){var
c=be(k),a=n(b),d=P(b,0),e=0;if(58<=d){if(71<=d){if(!(5<(d+en|0)>>>0))e=1}else
if(65<=d)e=1}else{var
f=0;if(32!==d)if(43<=d)switch(d-43|0){case
5:if(a<(c+2|0)&&1<a){var
j=0;if(dR===P(b,1)||88===P(b,1))j=1;if(j){var
...
p=k;else{var
o=$(k,j)+eB|0,q=0;if(59<o>>>0){if(33<(o-61|0)>>>0)q=1}else
if(2===o)q=1;if(!q){var
...
1:s(b,a[1],92);a[1]++;s(b,a[1],48+(c/er|0)|0);a[1]++;s(b,a[1],48+((c/10|0)%10|0)|0);a[1]++;s(b,a[1],48+(c%10|0)|0);break;case
...
c=o;for(;;){if(!(9<($(a,c)+dW|0)>>>0))g[1]++;var
r=c+1|0;if(h!==c){var
...
b=p;for(;;){var
f=$(a,b);if(9<(f+dW|0)>>>0)d(f);else{if(0===e[1]){d(95);e[1]=3}e[1]+=-1;d(f)}var
q=b+1|0;if(l!==b){var
...
a=gz}return bg(b,bz(a,c))}function
...
a=ha}return bg(b,bz(a,c))}function
...
a=gM}return bg(b,jP(a,c))}function
an(c,i,b){function
j(d){switch(c[1]){case
0:var
a=45;break;case
...
a=32}return jL(b,i,a)}function
r(c){var
a=jC(b);return 3===a?b<0.?hg:hh:4<=a?hi:c}switch(c[2]){case
5:var
...
a=t;for(;;){var
g=a8(h,a),u=25<(g+en|0)>>>0?g:g+eB|0;s(m,a,u);var
v=a+1|0;if(o!==a){var
...
d=fs;break;case
13:var
d=ft;break;default:e=1}switch(e){case
1:var
g=y(4);s(g,0,92);s(g,1,48+(b/er|0)|0);s(g,2,48+((b/10|0)%10|0)|0);s(g,3,48+(b%10|0)|0);var
d=L(g);break;case
2:var
h=y(1);s(h,0,b);var
d=L(h);break}var
...
4:return bh(c,a,d[4],d[2],d[3],hb,d[1]);case
5:return bh(c,a,d[4],d[2],d[3],hc,d[1]);case
6:return bh(c,a,d[4],d[2],d[3],hd,d[1]);case
7:return bh(c,a,d[4],d[2],d[3],he,d[1]);case
8:var
...
9:return bR(c,a,d[2],d[1],fg);case
10:var
...
19:throw[0,r,hk];case
20:var
ab=d[3],ac=[8,a,hl];return function(a){return f(c,ac,ab)};case
21:var
ad=d[2];return function(b){return f(c,[4,a,bz(hm,b)],ad)};case
22:var
...
2:throw[0,r,hn];default:return e<50?k(e+1|0,c,a,g):D(k,[0,c,a,g])}else
switch(p[0]){case
0:return e<50?k(e+1|0,c,a,g):D(k,[0,c,a,g]);case
1:return e<50?k(e+1|0,c,a,g):D(k,[0,c,a,g]);case
...
13:throw[0,r,ho];default:throw[0,r,hp]}}function
k(d,b,e,a){var
c=[8,e,hq];return d<50?a4(d+1|0,b,c,a):D(a4,[0,b,c,a])}function
b9(h,c,f,a,e,d){if(e){var
i=e[1];return function(e){return hj(c,f,a,i,b(d,e))}}var
g=[4,f,d];return h<50?a4(h+1|0,c,g,a):D(a4,[0,c,g,a])}function
f(a,b,c){return cM(a4(0,a,b,c))}function
Q(a,b,c,d){return cM(b_(0,a,b,c,d))}function
hj(a,b,c,d,e){return cM(b9(0,a,b,c,d,e))}function
...
switch(a[0]){case
0:var
g=a[1],h=c8(a[2]);ao(c,g);return aY(c,h);case
1:var
d=a[2],e=a[1];if(0===d[0]){var
i=d[1];ao(c,e);aY(c,hr);var
a=i;continue}var
j=d[1];ao(c,e);aY(c,hs);var
a=j;continue;case
6:var
...
2:case
4:var
k=a[2];ao(c,a[1]);return aY(c,k);default:var
l=a[2];ao(c,a[1]);return e4(c,l)}}function
at(c,g){var
a=g;for(;;)if(typeof
a==="number")return 0;else
switch(a[0]){case
0:var
h=a[1],i=c8(a[2]);at(c,h);return a1(c,i);case
1:var
e=a[2],f=a[1];if(0===e[0]){var
j=e[1];at(c,f);a1(c,ht);var
a=j;continue}var
k=e[1];at(c,f);a1(c,hu);var
a=k;continue;case
6:var
n=a[2];at(c,a[1]);return a1(c,b(n,0));case
7:var
a=a[1];continue;case
8:var
...
2:case
4:var
l=a[2];at(c,a[1]);return a1(c,l);default:var
m=a[2];at(c,a[1]);var
...
bW(i,h){var
a=i[1+h];if(1-(typeof
a==="number"?1:0)){if(bD(a)===bt)return b(ab(hv),a);if(bD(a)===253){var
d=cy(fk,a),c=0,g=n(d);for(;;){if(g<=c)return V(d,fj);var
e=P(d,c),f=0;if(48<=e){if(!(58<=e))f=1}else
if(45===e)f=1;if(f){var
c=c+1|0;continue}return d}}return hw}return b(ab(hx),a)}function
c$(b,a){if(b.length-1<=a)return hy;var
c=c$(b,a+1|0),d=bW(b,a);return R(ab(hz),d,c)}function
bX(a){function
o(f){var
c=f;for(;;){if(c){var
g=c[2],h=c[1];try{var
...
h=o(bU[1]);if(h)return h[1];if(a===bJ)return hE;if(a===cS)return hF;if(a[1]===cR){var
d=a[2],i=d[3],p=d[2],q=d[1];return b$(ab(bV),q,p,i,i+5|0,hG)}if(a[1]===r){var
e=a[2],j=e[3],s=e[2],t=e[1];return b$(ab(bV),t,s,j,j+6|0,hH)}if(a[1]===cU){var
f=a[2],k=f[3],u=f[2],v=f[1];return b$(ab(bV),v,u,k,k+6|0,hI)}if(0===bD(a)){var
g=a.length-1,w=a[1][1];if(2<g>>>0)var
l=c$(a,2),m=bW(a,1),c=R(ab(hA),m,l);else
switch(g){case
0:var
c=hB;break;case
1:var
c=hC;break;default:var
n=bW(a,1),c=b(ab(hD),n)}return V(w,c)}return a[1]}function
bY(h,t){var
e=jE(t);if([0,e]){var
g=e.length-1-1|0,q=0;if(!(g<0)){var
c=q;for(;;){var
a=eT(e,c)[1+c],f=function(a){return function(b){return b?0===a?hJ:hK:0===a?hL:hM}}(c);if(0===a[0])var
i=a[5],j=a[4],k=a[3],l=a[6]?hN:hP,m=a[2],n=a[7],o=f(a[1]),d=[0,ju(ab(hO),o,n,m,l,k,j,i)];else
if(a[1])var
d=0;else
var
p=f(0),d=[0,b(ab(hQ),p)];if(d){var
r=d[1];b(bS(h,hR),r)}var
s=c+1|0;if(g!==c){var
c=s;continue}break}}return 0}return bS(h,hS)}function
da(c){for(;;){var
a=bU[1],b=1-bI(bU,a,[0,c,a]);if(b)continue;return b}}var
hU=hT.slice();function
hV(e,d){var
f=bX(e);b(bT(hW),f);bY(aa,d);var
a=j4(0);if(a<0){var
c=be(a);cV(eT(hU,c)[1+c])}return aD(aa)}var
hX=[0];cK(a(dT),function(e,i){try{try{var
c=i?hX:eZ(0);try{bL(0)}catch(a){}try{var
a=hV(e,c),d=a}catch(a){a=bH(a);var
g=bX(e);b(bT(hZ),g);bY(aa,c);var
h=bX(a);b(bT(h0),h);bY(aa,eZ(0));var
d=aD(aa)}var
f=d}catch(a){a=bH(a);if(a!==bJ)throw a;var
f=cV(hY)}return f}catch(a){return 0}});var
dd=[x,h1,ar(0)],db=0,dc=-1;function
...
c=a[1],d=a[2];return j2(b,c)?[0,b,a]:[0,c,A(b,d)]}return[0,b,0]};z[1]=A(a[6]-a[9]|0,z[1])}break;case
1:aK(a[2]);break;case
2:aK(a[3]);break;case
3:var
...
a3(a,j);break;case
4:if(a[11]||!(a[9]<(l+n(D)|0)||((a[6]-f|0)+U|0)<a[10]))a3(a,j);else
aO(a,d,f);break;default:a3(a,j)}}break;case
2:var
...
var
p=o;var
L=p-o|0;if(0<=L)a3(a,[0,h5,L+W|0,h4]);else
aO(a,[0,h7,p+V|0,h6],a[6])}break;case
3:var
...
N=c[1];bZ(a,b(a[24],N));aJ(N,a[5])}a[12]=aa+a[12]|0;continue}throw fD}return P}return 0}}function
b1(a){a0(a);return aJ([0,-1,[0,dc,h8,0]],a)}function
di(a,c){var
d=aL(a[1]);if(d){var
...
c=h;continue}for(;;){if(1<a[14]){if(1<a[14]){if(a[14]<a[15]){bi(a,[0,db,1,0]);di(a,1);di(a,0)}a[14]=a[14]-1|0}continue}a[13]=de;dh(a);a[12]=1;a[13]=1;bN(a[28]);b1(a[1]);a0(a[2]);a0(a[3]);a0(a[4]);a0(a[5]);a[10]=0;a[14]=0;a[9]=a[6];a[14]=a[14]+1|0;var
...
h_(a){return a[1]===dd?V(ia,V(a[2],h$)):ib}function
ic(a){return a[1]===dd?V(ie,V(a[2],id)):ig}function
ih(a){return 0}function
ii(a){return 0}function
dm(i,h){function
j(a){return 0}function
k(a){return 0}var
c=[0,0,0,0],d=[0,dc,ij,0];function
l(a){return 0}c3(d,c);var
b=aZ(0);b1(b);aJ([0,1,d],b);var
e=aZ(0),f=aZ(0),g=aZ(0),a=[0,b,aZ(0),g,f,e,78,10,68,78,0,1,1,1,1,ff,ik,i,h,l,k,j,0,0,h_,ic,ih,ii,c];a[19]=function(b){return bl(a[17],h9,0,1)};a[20]=function(b){return dl(a,b)};a[21]=function(b){return dl(a,b)};return a}function
dn(c){function
a(a){return aD(c)}return dm(function(d,a,b){if(0<=a&&0<=b&&!((n(d)-b|0)<a))return cG(c,d,a,b);return as(fn)},a)}var
aP=c4(cc),im=dn(fl),io=dn(aa);function
il(a){return 0}dm(function(f,b,a){var
c=b<0?1:0;if(c)var
d=c;else
var
g=a<0?1:0,d=g||((n(f)-a|0)<b?1:0);if(d)as(fH);var
e=aP[2]+a|0;if(aP[3]<e)bO(aP,a);ax(f,b,aP[1],aP[2],a);aP[2]=e;return 0},il);cW(function(a){dj(im,0);return dj(io,0)});function
dp(b,a){var
c=bD(a)===x?a:a[1];return cK(b,c)}var
b2=g,b3=null,ip=undefined;function
b4(a,d,c){return a==b3?b(d,0):b(c,a)}var
ir=b2.Array,dq=[x,is,ar(0)];dp(it,[0,dq,{}]);(function(a){throw a});var
iq=false;da(function(a){return a[1]===dq?[0,Y(a[2].toString())]:0});da(function(a){return a
instanceof
ir?0:[0,Y(a.toString())]});var
dr=b2.document;function
ds(a,c){function
d(d){var
e=b(c,d);function
a(a){return[0,a]}return b4(e,function(a){return 0},a)}function
e(a){return 0}return b4(dr.getElementById(cF(a)),e,d)}ar(0);b2.HTMLElement===ip;function
dt(a){return a.tagName.toLowerCase()==="textarea"?a:b3}var
iy=[x,ix,ar(0)];ku(0);dp(iz,iy);var
du=0,dv=1;function
...
a==="number"&&typeof
b==="number")var
d=a+b|0,i=0<=((d^a)&(d^b))?d:fb(a,b);else
j=1;if(j)var
i=fb(a,b);return[0,[0,i,k]]}return 0}}return 0}return 0}function
...
switch(a[0]){case
0:var
b=ks(iA,a[1]);break;case
1:var
b=a[1]?iC:iD;break;case
2:var
b=a[1];break;default:var
b=iE}return[0,[0,[0,b,h],g]]}return 0}return 0}return 0}function
bk(aN,aM,aL,aK,aJ){var
c=aN,g=aM,a=aL,d=aK,b=aJ;for(;;){if(b){var
e=b[1];if(typeof
e==="number")switch(e){case
0:var
aO=b[2];if(a){var
v=a[1],bi=0;if(typeof
v==="number"||!(0===v[0]))bi=1;else{var
w=a[2];if(w){var
x=w[1];if(typeof
x!=="number"&&0===x[0]){var
a=[0,[1,eX(v[1],x[1])],w[2]],b=aO;continue}}}}return[0,c,d,0];case
1:var
aP=b[2];if(a){var
y=a[1],bj=0;if(typeof
y==="number"||!(0===y[0]))bj=1;else{var
z=a[2];if(z){var
A=z[1];if(typeof
A!=="number"&&0===A[0]){var
a=[0,[1,j1(y[1],A[1])],z[2]],b=aP;continue}}}}return[0,c,d,0];case
2:var
aQ=b[2];if(a){var
B=a[1],bl=0;if(typeof
B==="number"||!(1===B[0]))bl=1;else{var
C=a[2];if(C){var
D=C[1];if(typeof
D!=="number"&&1===D[0]){var
ac=B[1],aR=C[2],aS=D[1],aT=ac?aS:ac,a=[0,[1,aT],aR],b=aQ;continue}}}}return[0,c,d,0];case
3:var
aU=b[2];if(a){var
E=a[1],bm=0;if(typeof
E==="number"||!(1===E[0]))bm=1;else{var
F=a[2];if(F){var
G=F[1];if(typeof
G!=="number"&&1===G[0]){var
aX=E[1],aV=F[2],aW=G[1],aY=aX||aW,a=[0,[1,aY],aV],b=aU;continue}}}}return[0,c,d,0];case
4:var
aZ=b[2];if(a){var
H=a[1];if(typeof
H!=="number"&&1===H[0]){var
a=[0,[1,1-H[1]],a[2]],b=aZ;continue}}return[0,c,d,0];case
5:var
a0=b[2];if(a){var
I=a[1],bn=0;if(typeof
I==="number"||!(2===I[0]))bn=1;else{var
J=a[2];if(J){var
g=[0,[0,I[1],J[1]],g],a=[0,0,J[2]],b=a0;continue}}}return[0,c,d,0];case
6:var
a1=b[2];if(a){var
K=a[1],bo=0;if(typeof
K==="number"||!(2===K[0]))bo=1;else{var
L=a[2];if(L){var
c=[0,[0,K[1],L[1]],c],a=[0,0,L[2]],b=a1;continue}}}return[0,c,d,0];case
7:var
a2=b[2];if(a){var
M=a[1];if(typeof
M!=="number"&&2===M[0]){var
a3=a[2],a4=M[1],ad=cY(a4,aH(g,c));if(ad){var
a=[0,ad[1],a3],b=a2;continue}return[0,c,d,0]}}return[0,c,d,0];default:var
a5=b[2];if(a){var
k=a[1],bp=0;if(typeof
k==="number"||!(3===k[0]))bp=1;else{var
N=a[2];if(N){var
ae=k[3],af=k[2],ag=k[1],ah=[0,[0,af,N[1]],k[4]],a6=N[2],p=bk(c,[0,[0,ag,[3,ag,af,ae,ah]],ah],0,d,ae),ai=p[1],aj=p[3];if(aj){var
ak=aj[1];if(ak){var
c=ai,a=[0,ak[1],a6],d=p[2],b=a5;continue}}return[0,ai,p[2],0]}}}return[0,c,d,0]}else
switch(e[0]){case
0:var
...
1:var
a7=b[2],al=dw(e[1],a);if(al){var
a=al[1],b=a7;continue}return[0,c,d,0];case
2:var
a8=b[2],am=b5(e[1],a);if(am){var
an=am[1],a=[0,[0,an[1]],an[2]],b=a8;continue}return[0,c,d,0];case
3:var
...
t=a[1],W=0;if(typeof
t!=="number"&&0===t[0]){var
i=t[1],Z=b5(O-1|0,a[2]);if(Z){var
_=Z[1],m=_[1],aE=0,aG=_[2];if(typeof
i==="number"&&typeof
m==="number")var
Y=i-m|0,$=0<=((i^m)&(Y^i))?Y:fd(i,m);else
aE=1;if(aE)var
$=fd(i,m);var
l=[0,[0,$,aG]];W=1}else{var
l=0;W=1}}if(!W)V=1}else
V=1;if(V)var
l=0}else
var
l=0;if(l){var
ao=l[1],a=[0,[0,ao[1]],ao[2]],b=a9;continue}return[0,c,d,0];case
4:var
a_=b[2],ap=b6(e[1],a);if(ap){var
aq=ap[1],a=[0,[0,aq[1]],aq[2]],b=a_;continue}return[0,c,d,0];case
5:var
P=e[1],a$=b[2];if(0<=P)if(0===P)var
h=[0,[0,dv,a]];else{var
X=0;if(a){var
u=a[1],s=0;if(typeof
u!=="number"&&0===u[0]){var
f=u[1],aa=b6(P-1|0,a[2]);if(aa){var
ab=aa[1],j=ab[1],aI=ab[2];if(kr(0,j)){var
h=0;s=1}else{if(typeof
j==="number")if(-1===j){var
aF=0;if(typeof
...
var
o=typeof
f==="number"?jF(f,j):fc(f,j);else
var
o=fc(f,j);var
h=[0,[0,o,aI]];s=1}}else{var
h=0;s=1}}if(!s)X=1}else
X=1;if(X)var
h=0}else
var
h=0;if(h){var
ar=h[1],a=[0,[0,ar[1]],ar[2]],b=a$;continue}return[0,c,d,0];case
6:var
ba=b[2],as=dx(e[1],a);if(as){var
at=as[1],bb=at[2],a=bb,d=aH(cX(at[1]),d),b=ba;continue}return[0,c,d,0];case
7:var
bc=b[2],r=bk(c,g,0,d,e[1]),au=r[1],av=r[3];if(av){var
aw=av[1];if(aw){var
c=au,a=[0,aw[1],a],d=r[2],b=bc;continue}}return[0,au,r[2],0];case
8:var
ax=b[2],bd=e[2],be=e[1];if(a){var
Q=a[1];if(typeof
Q!=="number"&&1===Q[0]){var
ay=a[2];if(Q[1]){var
a=ay,b=aH(be,ax);continue}var
a=ay,b=aH(bd,ax);continue}}return[0,c,d,0];case
9:var
az=e[1],g=[0,[0,az,[3,az,e[2],e[3],g]],g],b=b[2];continue;case
10:var
aA=b[2],R=bk(c,g,0,d,e[1]),aB=R[3],S=R[2],T=R[1];if(aB){var
aC=aB[1];if(aC){var
c=T,a=[0,aC[1],a],d=S,b=aA;continue}return[0,T,S,0]}var
c=T,d=S,b=aA;continue;default:var
bf=b[2],bg=e[1];if(a){var
U=a[1];if(typeof
U!=="number"&&0===U[0]){var
bh=a[2],aD=cY(U[1],bg);if(aD){var
a=bh,b=aH(aD[1],bf);continue}return[0,c,d,0]}}return[0,c,d,0]}}return[0,c,d,[0,a]]}}function
dy(a){var
b=97<=a?1:0,c=b?a<=eH?1:0:b;return c}function
dz(a){var
...
b=eR(d,a),e=a+1|0;return[0,b,function(a){return c(e,a)}]}var
a=0;function
...
g=cZ(2*H(a[1])|0,aI);if(H(a[1])===g)bc(fy);var
...
iH(a){if(a){var
b=a[2];return fA(iI,0,a[1])?[0,[0,0,b]]:0}return 0}var
iJ=0,W=dE(function(a){return aQ(iH,a)},iJ);function
...
var
a=0;if(a){var
h=a[1],j=h[2];return[0,[0,jZ(dC(h[1])),j]]}return 0}function
i(e){var
a=0;function
b(f){var
b=dB(e),a=f;for(;;){if(b){if(a){var
c=a[2],d=b[2];if(eX(a[1],b[1])){var
b=d,a=c;continue}return 0}return 0}return[0,[0,0,a]]}}return dE(function(a){return dD(b,W,a)},a)}function
iL(f){function
a(g){var
b=dC([0,f,g]),a=iK;for(;;){if(a){var
e=a[2],c=e9(a[1],b);if(!c){var
a=e;continue}var
d=c}else
var
d=0;if(d)return iG;var
...
iM(a){return b7(iF,a)}function
b8(a){return c(iM,iL,a)}function
aB(aL){function
am(g){function
e(a){function
b(c){var
b=[11,a];return function(a){return j(b,a)}}var
d=i(jf);return function(a){return c(d,b,a)}}function
a(d){function
a(a){function
b(b){var
...
d=i(jc);return function(a){return c(d,b,a)}}var
...
f=i(i$);return function(a){return c(f,e,a)}}var
...
e=i(i8);return function(a){return c(e,d,a)}}var
d=aB(0);return function(a){return c(d,b,a)}}var
d=i(i9);return function(a){return c(d,b,a)}}var
b=aB(0);return function(d){return c(b,a,d)}}var
aa=i(i_);function
...
d=i(i6);return function(a){return c(d,b,a)}}var
b=aB(0);return function(d){return c(b,a,d)}}var
Z=i(i7);function
...
iv(a){throw bd}var
iw=b4(dr.getElementById("button"),iv,iu),dG=ds(jn,dt),jo=dG?dG[1]:bc(js),dH=ds(jp,dt),jq=dH?dH[1]:bc(jr);function
dI(j){var
h=Y(jo.value),g=aB(0),f=dD(W,g,dB(h)),a=0;if(f){var
c=f[1];if(c[2])a=1;else
var
d=bk(0,0,0,0,c[1]),i=d[2],e=d[3]?i:jm}else
a=1;if(a)var
e=jl;function
b(a){if(a){var
c=a[1];return a[2]?V(c,V(jh,b(a[2]))):c}return ji}jq.value=cF(V(jk,V(b(e),jj)));return iq}iw.onclick=function(a){if(1-(a==b3?1:0)){var
